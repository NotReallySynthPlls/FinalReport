...
For this prototype design, the $CLK_{DCO}$ was chosen to have an $f_{MAX}$ of 5GHz to match the reported $f_{MAX}$ in \cite{hashimoto2018}. This PLL was designed with a $CLK_{REF}$ frequency of 500MHz and a nominal division ratio $N_{DIV}^{sync}$ of 10. The DCO design consisted of 
\begin{figure}[h]
	\centering
	\includegraphics[width=\columnwidth]{fig_phasemargin}
	\caption{Top-level implementation of PLL-based scheme from \cite{hashimoto2018}.}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=\columnwidth]{fig_dco}
